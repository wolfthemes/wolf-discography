	...
	public function add_custom_block_category( $categories ) {
		array_unshift(
			...
			array(
				...
				'title' => esc_html__( 'Discography', 'wolf-discography' ),
				'icon'  => 'album',
			)
		);
		return $categories;
