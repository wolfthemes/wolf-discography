...
class WD_Options {
	...
	public function register_settings() {
		...
		add_settings_field( 'use_band_tax', esc_html__( 'Link Band Name to category page', '%TEXTDOMAIN%' ), array( $this, 'setting_use_band_tax' ), 'wolf-release-settings', 'wolf-release-settings' );
		add_settings_field( 'use_label_tax', esc_html__( 'Link Label Name to category page', '%TEXTDOMAIN%' ), array( $this, 'setting_use_label_tax' ), 'wolf-release-settings', 'wolf-release-settings' );
		add_settings_field( 'display_format', esc_html__( 'Display format (like CD, digital download etc...)', '%TEXTDOMAIN%' ), array( $this, 'setting_display_format' ), 'wolf-release-settings', 'wolf-release-settings' );
	}
