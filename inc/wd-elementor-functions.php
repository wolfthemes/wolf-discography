 ...
 * @return void
 */
function wd_convert_params_to_elementor( $widget, $params = array() ) {
 ...
 * @return void
 */
function wd_register_elementor_controls( $widget ) {
	...
	wd_convert_params_to_elementor( $widget, $content_group_params );
	...
	if ( array() !== $query_group_params ) {
		...
		wd_convert_params_to_elementor( $widget, $query_group_params );
	...
	if ( array() !== $style_group_params ) {
		...
		wd_convert_params_to_elementor( $widget, $style_group_params );
	...
	if ( array() !== $custom_group_params ) {
		...
		wd_convert_params_to_elementor( $widget, $custom_group_params );
	...
	if ( array() !== $extra_group_params ) {
		...
		wd_convert_params_to_elementor( $widget, $extra_group_params );
	...
	if ( array() !== $advanced_group_params ) {
		...
		wd_convert_params_to_elementor( $widget, $advanced_group_params );
	...
	if ( array() !== $options_group_params ) {
		...
		wd_convert_params_to_elementor( $widget, $options_group_params );
