...
if ( ! class_exists( 'WD_Admin_Metabox' ) ) {
	...
	class WD_Admin_Metabox {
		...
		public function admin_scripts() {
			...
			/* Datepicker JS */
			wp_enqueue_script( 'wolf-discography-datepicker', WD_JS . '/admin/datepicker.min.js', array( 'jquery-ui-datepicker' ), false, true );
			wp_enqueue_script( 'wolf-discography-repeatable', WD_JS . '/admin/repeatable.min.js', array( 'jquery-ui-datepicker' ), false, true );
		}
		...
		public function render() {
			...
			foreach ( $this->meta as $k => $v ) {
				...
				if ( isset( $v['help'] ) ) {
					echo '<div class="wolf-discography-metabox-help">' . $v['help'] . '</div>';
				}
			}
